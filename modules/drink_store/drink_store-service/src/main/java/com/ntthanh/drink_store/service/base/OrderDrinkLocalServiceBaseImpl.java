...
import com.ntthanh.drink_store.service.OrderDrinkLocalService;
...
/**
 * Provides the base implementation for the order drink local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ntthanh.drink_store.service.impl.OrderDrinkLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ntthanh.drink_store.service.impl.OrderDrinkLocalServiceImpl
 * @generated
 */
public abstract class OrderDrinkLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, OrderDrinkLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OrderDrinkLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>OrderDrinkLocalServiceUtil</code>.
	 */
	...
	public OrderDrink addOrderDrink(OrderDrink orderDrink) {
		...
		return orderDrinkPersistence.update(orderDrink);
	}
	...
	public OrderDrink createOrderDrink(long id) {
		return orderDrinkPersistence.create(id);
	}
	...
	public OrderDrink deleteOrderDrink(long id) throws PortalException {
		return orderDrinkPersistence.remove(id);
	}
	...
	public OrderDrink deleteOrderDrink(OrderDrink orderDrink) {
		return orderDrinkPersistence.remove(orderDrink);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return orderDrinkPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OrderDrink.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return orderDrinkPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return orderDrinkPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return orderDrinkPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return orderDrinkPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public OrderDrink fetchOrderDrink(long id) {
		return orderDrinkPersistence.fetchByPrimaryKey(id);
	}
	...
	public OrderDrink getOrderDrink(long id) throws PortalException {
		return orderDrinkPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(orderDrinkLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OrderDrink.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(OrderDrink.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return orderDrinkPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OrderDrinkLocalServiceImpl#deleteOrderDrink(OrderDrink) to avoid orphaned data");
		}

		return orderDrinkLocalService.deleteOrderDrink(
			(OrderDrink)persistedModel);
	}

	@Override
	public BasePersistence<OrderDrink> getBasePersistence() {
		return orderDrinkPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return orderDrinkPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OrderDrink> getOrderDrinks(int start, int end) {
		return orderDrinkPersistence.findAll(start, end);
	}
	...
	public int getOrderDrinksCount() {
		return orderDrinkPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OrderDrinkLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		orderDrinkLocalService = (OrderDrinkLocalService)aopProxy;

		_setLocalServiceUtilService(orderDrinkLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return OrderDrinkLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = OrderDrinkLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, orderDrinkLocalService);
		}
	...
	protected OrderDrinkLocalService orderDrinkLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OrderDrinkLocalServiceBaseImpl.class);
