...
/**
 * Provides the local service interface for OrderDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OrderDetailLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OrderDetailLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ntthanh.drink_store.service.impl.OrderDetailLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the order detail local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OrderDetailLocalServiceUtil} if injection and service tracking are not available.
	 */
