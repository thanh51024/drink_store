 ...
 * <code>com.ntthanh.drink_store.service.impl.DrinkLocalServiceImpl</code> and
...
public class DrinkLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ntthanh.drink_store.service.impl.DrinkLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Drink createDrink(long id) {
		return getService().createDrink(id);
	}
	 ...
	 */
	public static Drink deleteDrink(Drink drink) {
	 ...
	 */
	public static Drink deleteDrink(long id) throws PortalException {
		return getService().deleteDrink(id);
	}
	...
	public static Drink fetchDrink(long id) {
	 ...
	 * @throws PortalException if a drink with the primary key could not be found
	 */
	public static Drink getDrink(long id) throws PortalException {
		return getService().getDrink(id);
	}
	 ...
	 */
	public static List<Drink> getDrinks(int start, int end) {
	...
	private static volatile DrinkLocalService _service;
